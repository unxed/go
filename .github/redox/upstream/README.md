...
|---|---|---|---|---|---|
| 1 | kernel | A ForceKill that lands while the target thread is about to block is lost (`Context::block()` overwrites Runnable with Blocked); the process never finishes exiting | `x17_exit_c` | 35403271670 (stock 14/60 `exit()` hangs, master 8/60, patched 0/60; `_exit` 2/30, 0/30, 0/30) | **patch verified**: `../kernel/0001-context-never-block-a-force-killed-context.patch`, `../kernel/ISSUE.md` |
